...
let categoryBasedExpressSchema = mongoose.Schema(
  {
    ...
    eligibilityExpressEntrySteps: {
      ...
      default: [
        ...
        "Choose Your Program: There are three programs available for eligibility to join the Express Entry pool: Federal Skilled Worker Program (FSW): This program is ideal for tech workers who possess the necessary work experience, education, and language skills. Canadian Experience Class (CEC): Similar to the FSW program, the CEC is suitable for tech workers with Canadian work experience. Federal Skilled Trades Program (FSTP): Designed for trades workers, this program requires proof of relevant work experience, education, and language proficiency.",
    ...
    eligibleNOCCodesNote: {
      type: String,
      default:
        "Candidates must demonstrate that they performed 51% or more of the main duties in the NOC description and match the lead statement.",
    },
    ...
    faqs: {
      ...
      default: [
        { question: "Is this a separate immigration program?", answer: "No. It’s part of the existing Express Entry system but prioritizes candidates with work experience in select occupations." },
        { question: "Do I need a job offer?", answer: "Not required, but it can improve your CRS score." },
        { question: "Can I qualify if I have foreign teaching experience?", answer: "Yes, if your experience aligns with a listed NOC and meets Canadian equivalency through credential assessment." },
        { question: "What is the average CRS score for education draws?", answer: "It varies by round but is generally lower than general draws, often between 430–470." },
        { question: "Is certification or licensing required?", answer: "Not for Express Entry eligibility, but provincial certification may be required later for employment." },
      ],
    },
